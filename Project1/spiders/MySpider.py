...
from Project1.FlightItems import EnterPortItem,LeavePortItem
class MySpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for box in response.xpath('//*[@id="icefable1"]/li'):
            ...
            item['origin'] = box.xpath('./span[2]/text()').extract()[0]
        ...
        for box in response.xpath('//*[@id="icefable2"]/li'):
            ...
            item2['destination'] = box.xpath('./span[2]/text()').extract()[0]
